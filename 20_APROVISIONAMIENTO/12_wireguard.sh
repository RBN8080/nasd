...
aviso ""
aviso "  IPHONE — ACTIVACIÓN BAJO DEMANDA DESPUÉS DE IMPORTAR EL QR"
aviso "     Editar el túnel > Activación bajo demanda:"
aviso "       Celular: activado"
aviso "       Wi-Fi: activado"
aviso "       SSIDs: Excepto estos SSIDs"
aviso "       Añadir conectado: la red Wi-Fi de casa"
aviso "     Así se apaga solo en casa y se activa en datos móviles o Wi-Fi ajena."
aviso "     Si cambia el nombre de la red de casa, actualice también esta excepción."
aviso ""
aviso "LOS PERFILES LLEVAN CLAVE PRIVADA: no se envían por chat ni por correo,"
aviso "y NUNCA entran en el repositorio (P4)."
aviso ""
aviso "PRUEBA COMPLETA DEL IPHONE (D-21):"
aviso "  1. Wi-Fi de casa: el túnel queda inactivo y SMB abre directo."
aviso "  2. Apagar Wi-Fi: el túnel se activa y SMB abre por datos móviles."
aviso "  3. Volver a casa: el túnel se apaga y SMB sigue abriendo."
aviso "Probar solo uno de los dos caminos no demuestra la transición."
